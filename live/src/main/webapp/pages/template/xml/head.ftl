...
<head>
	...
	<style>
		/* colorbox */
		#cboxOverlay { background: none repeat scroll 0 0 #000009 !important; opacity : 0.2 !important; }
		#cboxTitle { font-weight:normal !important; }
		form.listform legend { font-weight:normal !important; }
		form.listform li.foot { padding-left : 0px !important; text-align : center; }
	</style>
${tag.body}
</head>
<body>
...
[#if compressed=="false"]
	...
	<script src="${base}/static/scripts/artDialog4.1.0/jquery.artDialog.js?skin=default"></script>
[#else]
	[@sj.head/]
	<link id="beangle_theme_link" href="${base}/static/themes/${b.theme.ui}/beangle-ui.css" rel="stylesheet" type="text/css" />
	<link href="${base}/static/themes/${b.theme.ui}/colorbox.css" rel="stylesheet" type="text/css" />
