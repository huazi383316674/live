jQuery.fn.extend({cssRadio:function(){
	 jQuery(this).each( function(){
        if ( jQuery(this).prev()[0].checked ) {
            jQuery(this).find("img").attr("src",bg.getContextPath()+"/static/themes/radio/images/radio2.gif");
          }
        })
    .click( function() { 
        ...
        jQuery(".radioClass", contents).each( function() { 
            jQuery(this).prev()[0].checked=false; 
             jQuery(this).find("img").attr("src",bg.getContextPath()+"/static/themes/radio/images/radio1.gif"); 
        }); 
