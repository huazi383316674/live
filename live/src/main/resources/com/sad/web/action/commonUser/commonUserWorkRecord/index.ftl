[#ftl]
[@b.head/]
[@b.toolbar title="工作记录管理"]
	bar.addItem("关联用户", "toRelateUser");
[/@]
[@b.messages slash='3'/]
...
<script>
	...
	function moneySync() {
		...
		bg.form.addInput(document.calendarSearchForm, "factMoney", factMoney.value);
		bg.form.addInput(document.calendarSearchForm, "userRange", document.getElementById("userRange").value);
		bg.form.submit(document.calendarSearchForm, "commonUserConsume!moneySync.action", "main");
	}
</script>
[@b.foot/]